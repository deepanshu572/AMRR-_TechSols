...
const ViewItemDetail = () => {
  ...
  return (
    <>
      {" "}
      <h2 className="pb-3 text-center mt-7 text-2xl uppercase font-bold  ">
        Detail Page
      </h2>
      <div className="details flex h-[100vh] gap-4 items-center justify-center">
        ...
        <div className="txt_right  w-[25rem] ">
          <h2>Item Name :{FilterData?.name}</h2>
          <p>Item Type : {FilterData?.type}</p>
          <small>Description : {FilterData?.desc}</small>
        </div>
      </div>
    </>
  );
